...
class OwnerController {
    ...
    public String createDummyData() {
        Owners o1 = new Owners(1, "John", "Doe", "404 Not found", "some numbers", "John Doe Class of 1980");
        Owners o2 = new Owners(2, "Jane", "Doe", "Its a secret", "you wish", "Jane Doe Class of 1982");
        Owners o3 = new Owners(3, "Some", "Pleb", "Right next to the Library", "515-345-41213","Class of your mom");
        Owners o4 = new Owners(4, "Chad", "Champion", "Reddit memes corner", "420-420-4200", "Didn't graduate");
